...
const AboutSection = () => {
  return (
    <section id="about-section" className="about-section container py-20">
      ...
      <h4 className="text-primary-lightText text-center">My Introduction</h4>
      <div className="w-full flex flex-col md:flex-row items-start justify-around gap-10 mt-16">
        <div className="profile-image-wrapper w-fit">
          <Image
            src={ProfilePicture}
            alt=""
        ...
        <div className="about-content md:basis-2/4 space-y-10">
          ...
          <div className="stats-group flex items-center justify-between">
            <Stat title="Years experience" value={"3+"} />
            <Stat title="Projects completed" value={"17+"} />
            <Stat title="Companies worked" value={"3+"} />
          </div>
          <button role="button" className="flex items-center gap-1 bg-primary p-2 text-primary-body text-sm rounded-lg">
